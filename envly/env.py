...
__all__ = ('Default', 'Some', 'Nothing', 'Okay', 'Error', 'using')\
    + enumly.__all__ + _env_bootstrap.__all__
...
def using(enum_cls: EnumClass) -> None:
    ...
    """
    global sys
    assert isinstance(enum_cls, EnumClass) and not isinstance(enum_cls, EnumVariantClass)
