...
type_uint32 fn_main(){ 
    ...
    { /* assignment [file:'examples/new_grammar.lvr' line:20 col:9] */
    ...
    { /* assignment [file:'examples/new_grammar.lvr' line:53 col:9] */
        type_Coord* target_ptr = &(cntnptr_Widget(&(var_button))->mbr_pos);
        type_Coord prev_value = *target_ptr;
        *target_ptr = get_Coord(var_second);
        drop_Coord(prev_value);
    }
    { /* assignment [file:'examples/new_grammar.lvr' line:59 col:9] */
